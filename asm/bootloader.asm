...
; =============================================================================
; 64-bit mode
;;;;;;;;;;;;;;; tema estructura vbeModeInfoblock desde uefi ya viene configurada asi, por lo que no tiene que hacer nada.. 
;;;;;; tan solo cuidar de no pisarla
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;[0x00005F00]		; Frame buffer base
;;;[0x00005F08]		; Frame buffer size (bytes)
;;;[0x00005F10]	; Screen X
...
start64:
	...
	;;;;;;;;;;;;;;;;;; porque vbe info block lo llena para bios y uefi
...
;;;;[0x00005F14]	; PixelsPerScanLine
	...
	mov eax, 0x00404040;;;;;;;;;;;;este es el color q pone
	rep stosd
...
jc pdpte_1GB;;pruebo de dejarlo
	;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;jc pdpte_1GB
