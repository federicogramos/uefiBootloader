...
;;;;;;;;;;;;;;;;;;
	...
	jmp 0x00100000			; Done with transient system, goto Kernel.
...
msg_system_setup_ready db "Sys setup ready: about to jump to kernel...", 0x0A, 0
...
msg_pdpt	db "PDPT... ", 0
msg_pd		db "PD... ", 0
msg_support_1g_pages:	db "Support 1GB pages = ", 0
